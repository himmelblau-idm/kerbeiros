...
impl CredentialWarehouseCCacheMapper {
    pub fn credential_warehouse_to_ccache(
        ...
        for credential in credentials.iter() {
            ccache_credentials.push(
                CredentialCCacheMapper::credential_to_ccache_credential(
                    credential,
                ),
            );
        }
    ...
    pub fn ccache_to_credential_warehouse(
        ccache: &CCache,
    ) -> Result<CredentialWarehouse> {
        let (realm, client) =
        ...
        for credential_entry in ccache_credentials.iter() {
            let credential =
                CredentialCCacheMapper::ccache_credential_to_credential(
                    credential_entry.clone(),
                )?;
...
mod test {
    ...
    fn convert_credential_warehouse_to_ccache() {
        ...
        let ticket = ccache::CountedOctetString::new(vec![
            ...
            0x30, 0x21, 0xa0, 0x03, 0x02, 0x01, 0x01, 0xa1, 0x1a, 0x30, 0x18,
            ...
            ,
        ]);
    ...
    fn convert_ccache_to_credential_warehouse() {
        ...
        assert_eq!(
            ...
            CredentialWarehouseCCacheMapper::ccache_to_credential_warehouse(
                &ccache
            )
            .unwrap()
        );

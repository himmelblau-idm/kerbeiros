...
mod test {
    ...
    fn test_generate_aes_128_key() {
        ...
        assert_eq!(
            vec![
                0x19, 0xa9, 0xb7, 0xc0, 0x87, 0xf8, 0xfd, 0x3d, 0xf5, 0x94, 0xaf, 0xd2, 0xc7, 0xf6,
                0x64, 0x73
            ],
        ...
        assert_eq!(
            vec![
                0x83, 0x91, 0x03, 0x34, 0x5b, 0x8b, 0x01, 0x69, 0xb6, 0xff, 0x47, 0xe6, 0x14, 0xe6,
                0xce, 0xec
            ],
        ...
        assert_eq!(
            vec![
                0x66, 0x6b, 0x33, 0x75, 0x4d, 0x8b, 0xdd, 0x0e, 0xd2, 0x58, 0x99, 0x93, 0xcb, 0xcc,
                0x77, 0x8e
            ],
    ...
    fn test_generate_aes_256_key() {
        ...
        assert_eq!(
            vec![
                0x99, 0xc8, 0x9e, 0xd5, 0x12, 0x19, 0x84, 0xc8, 0xe4, 0x12, 0xc1, 0xa7, 0xc1, 0x34,
                0x69, 0x0f, 0x61, 0xc9, 0x55, 0x48, 0x38, 0x8b, 0xba, 0x20, 0x8f, 0xd9, 0xd9, 0x98,
                0x6c, 0x8f, 0x77, 0xd6
            ],
        ...
        assert_eq!(
            vec![
                0x86, 0x95, 0xf8, 0x2e, 0x92, 0x0e, 0x0a, 0xce, 0x42, 0x9b, 0x8d, 0x9e, 0xf6, 0x19,
                0x67, 0x0d, 0x03, 0x67, 0x43, 0x0c, 0x12, 0xb3, 0x23, 0x3f, 0x32, 0xc5, 0xc8, 0x9f,
                0xb7, 0xd6, 0x04, 0xff
            ],
        ...
        assert_eq!(
            vec![
                0xd6, 0x52, 0xf8, 0x5d, 0x86, 0x5d, 0x92, 0xe3, 0x47, 0xf6, 0xa5, 0x6b, 0x63, 0x5d,
                0x31, 0x02, 0x3b, 0x92, 0x65, 0x1a, 0x00, 0x2c, 0x05, 0x9d, 0x8d, 0xb8, 0xee, 0x2a,
                0x06, 0xd2, 0x65, 0x0f
            ],

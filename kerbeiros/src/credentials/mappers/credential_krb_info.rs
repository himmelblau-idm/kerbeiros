...
impl CredentialKrbInfoMapper {
    ...
    fn decrypt_enc_kdc_rep_part_with_password(password: &str, kdc_rep: &KdcRep) -> Result<Vec<u8>> {
        let cipher = new_kerberos_cipher(kdc_rep.enc_part_etype())?;
        ...
        match Self::try_decrypt_enc_kdc_rep_part_with_cipher_key(key, kdc_rep) {
            Err(error) => {
                if key.etype() != kdc_rep.enc_part_etype() {
                    return Err(CryptographyErrorKind::DecryptionError(format!(
                        "Key etype = {} doesn't match with message etype = {}",
                        key.etype(),
                        kdc_rep.enc_part_etype()
                    )))?;
                }
...
mod test {
    ...
    fn decode_and_decrypt_enc_part_aes256_with_key() {
        ...
        assert_eq!(
            ...
            CredentialKrbInfoMapper::kdc_rep_to_credential(
                &Key::AES256Key([
                    0xd3, 0x30, 0x1f, 0x0f, 0x25, 0x39, 0xcc, 0x40, 0x26, 0xa5, 0x69, 0xf8, 0xb7,
                    0xc3, 0x67, 0x15, 0xc8, 0xda, 0xef, 0x10, 0x9f, 0xa3, 0xd8, 0xb2, 0xe1, 0x46,
                    0x16, 0xaa, 0xca, 0xb5, 0x49, 0xfd
                ]),
                &as_rep
            )
            .unwrap()
    ...
    fn decode_and_decrypt_enc_part_aes256_with_key_of_aes128() {
        ...
        assert_eq!(
            ...
            CredentialKrbInfoMapper::kdc_rep_to_credential(
                &Key::AES128Key([
                    0x61, 0x7f, 0x72, 0xfd, 0xbc, 0x85, 0x1c, 0x45, 0x9a, 0x1c, 0x39, 0xbf, 0x83,
                    0x23, 0x56, 0x09
                ]),
                &as_rep
            )
    ...
    fn create_as_rep_aes256_to_decrypt() -> KdcRep {
        let encrypted_data = EncryptedData::new(
            AES256_CTS_HMAC_SHA1_96,
            vec![
                ,
            ],
        );
    ...
    fn create_credential_to_check_decryption() -> Credential {
        ...
        let encryption_key = EncryptionKey::new(
            AES256_CTS_HMAC_SHA1_96,
            vec![
                0x63, 0x7b, 0x4d, 0x21, 0x38, 0x22, 0x5a, 0x3a, 0x0a, 0xd7, 0x93, 0x5a, 0xf3, 0x31,
                0x22, 0x68, 0x50, 0xeb, 0x53, 0x1d, 0x2d, 0x40, 0xf2, 0x19, 0x19, 0xd0, 0x08, 0x41,
                0x91, 0x72, 0x17, 0xff,
            ],
        );
